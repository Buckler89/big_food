...
t = {
    ...
    "Enter your other option...": {
        "en": "Enter your other option...",
        "es": "Ingrese su otra opción...",
        "fr": "Entrez votre autre option...",
        "de": "Geben Sie Ihre andere Option ein...",
        "it": "Inserisci la tua altra opzione...",
        "pt": "Digite sua outra opção...",
        "ja": "他のオプションを入力してください...",
        "ko": "다른 옵션을 입력하십시오...",
        "zh": "输入您的其他选项...",
    },
    "Checking db integrity...": {
        "en": "Checking db integrity...",
        "es": "Comprobando la integridad de la base de datos...",
        "fr": "Vérification de l'intégrité de la base de données...",
        "de": "Überprüfung der Datenbankintegrität...",
        "it": "Verifica dell'integrità del database...",
        "pt": "Verificando a integridade do banco de dados...",
        "ja": "データベースの整合性を確認中...",
        "ko": "데이터베이스 무결성 확인 중...",
        "zh": "检查数据库完整性...",
    },
    ...
    "semi-finished product added successfully": {
        "en": "Semi-finished product added successfully",
        "es": "Producto semielaborado agregado con éxito",
        "fr": "Produit semi-fini ajouté avec succès",
        "de": "Halbfertiges Produkt erfolgreich hinzugefügt",
        "it": "Prodotto semilavorato aggiunto con successo",
        "pt": "Produto semi-acabado adicionado com sucesso",
        "ja": "半製品が正常に追加されました",
        "ko": "준설제가 성공적으로 추가되었습니다",
        "zh": "半成品成功添加",
    },
    "ingredients consumed successfully": {
        "en": "Ingredients consumed successfully",
        "es": "Ingredientes consumidos con éxito",
        "fr": "Ingrédients consommés avec succès",
        "de": "Zutaten erfolgreich verbraucht",
        "it": "Ingredienti consumati con successo",
        "pt": "Ingredientes consumidos com sucesso",
        "ja": "材料が正常に消費されました",
        "ko": "성분이 성공적으로 소비되었습니다",
        "zh": "成分成功消耗",
    },
    "Productions on hold": {
        "en": "Productions on hold",
        "es": "Producciones en espera",
        "fr": "Productions en attente",
        "de": "Produktionen auf Eis",
        "it": "Produzioni in sospeso",
        "pt": "Produções em espera",
        "ja": "保留中の生産",
        "ko": "보류 중인 생산",
        "zh": "生产暂停",
    },
    "Close Production": {
        "en": "Close Production",
        "es": "Cerrar producción",
        "fr": "Fermer la production",
        "de": "Produktion schließen",
        "it": "Chiudi produzione",
        "pt": "Fechar produção",
        "ja": "生産を終了",
        "ko": "생산 종료",
        "zh": "关闭生产",
